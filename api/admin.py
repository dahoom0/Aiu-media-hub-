...
class EquipmentRentalAdmin(admin.ModelAdmin):
    list_display = ['equipment', 'student', 'rental_date', 'expected_return_date', 'actual_return_date', 'status']
    list_filter = ['status', 'rental_date']
    search_fields = ['student__username', 'student__student_profile__student_id', 'equipment__name']
